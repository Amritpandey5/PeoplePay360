...
export default function LoginPage() {
    ...
    const handleSubmit = async (
        ...
        try {
            ...
            router.push(loginType === "manager" ? "/manager" : "/employee");
        } catch (error: any) {
        ...
        <main className="min-h-screen bg-[#f7f9f8] lg:grid lg:h-screen lg:grid-cols-[45%_55%] lg:overflow-hidden">
            ...
            <section className="flex min-h-screen items-center justify-center overflow-y-auto px-5 py-8 sm:px-8 lg:h-screen lg:min-h-0 lg:px-12 lg:py-6 xl:px-20">
                <div className="w-full max-w-md">
                    ...
                    <div className="mb-6">
                        <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-50 text-[#063d2f] lg:hidden">
                            <span className="text-xl font-bold">P</span>
                        </div>
                        ...
                        <p className="mt-2 text-sm leading-6 text-slate-500">
                            Use your work credentials to access PeoplePay360.
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    ...
                                    className={`flex h-12 items-center justify-center gap-2 rounded-xl border text-sm font-semibold transition ${loginType === "employee"
                                ...
                                <button
                                    ...
                                    className={`flex h-12 items-center justify-center gap-2 rounded-xl border text-sm font-semibold transition ${loginType === "manager"
                                            ? "border-emerald-600 bg-emerald-50 text-[#063d2f] ring-4 ring-emerald-600/10"
                                            : "border-slate-200 bg-white text-slate-500 hover:border-slate-300 hover:bg-slate-50"
                                        }`}
                                >
