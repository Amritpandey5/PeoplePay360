...
export default function AdminDashboard() {
    ...
    const activeEmployees = dashboard.stats.activeEmployees;
    const inactiveEmployees = dashboard.stats.inactiveEmployees;
    const activeUsers = dashboard.stats.activeUsers;
    const totalEmployees = dashboard.stats.totalEmployees;
                ...
                <div className="mx-auto max-w-[1600px]">
                    ...
                    <section className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
                        <DashboardStat
                            ...
                            value={isLoading ? 0 : totalEmployees}
